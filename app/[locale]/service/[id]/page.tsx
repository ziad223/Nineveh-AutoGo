    ...
    <div className="w-full mb-10">
      ...
      <Container>
        <section className="relative rounded-xl w-full h-[60vh] mt-7 text-white flex items-center overflow-hidden">
          <Image
            src={getImageUrl(coverImage, "/images/hero-1.webp")}
            alt={(service.title && typeof service.title === 'string') ? service.title : 'service'}
            fill
          ...
          <div className="relative mx-auto text-center px-6 max-w-3xl">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: typeof service.content === 'string' ? service.content : "",
              }}
            />
          </div>
        </section>
