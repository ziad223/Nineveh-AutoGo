      ...
      <div className=" w-full rounded-2xl p-6 md:p-10 mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start gap-6">
          <div className="md:w-1/2 text-gray-800 text-lg">
            <div className="wrap-break-word whitespace-pre-line" dangerouslySetInnerHTML={{ __html: typeof data.content === 'string' ? data.content : "" }} />
          </div>

          <div className="relative w-full md:w-1/2 h-64 md:h-96 rounded-xl">
            <Image
              src={getImageUrl(data.image, "/images/hero-1.webp")}
              alt={(typeof data.title === 'string' && data.title.trim() !== "") ? data.title : "page"}
              fill
